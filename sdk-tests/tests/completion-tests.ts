...
export const completionContextSize512 = createCompletionTest(
  ...
  {
    history: [{ role: 'user', content: 'What is 1+1? Answer with only the number.' }],
    stream: false,
  },
...
export const completionZeroTemperature = createCompletionTest(
  ...
  {
    history: [{ role: 'user', content: 'What is 20 + 20? Answer with just the number.' }],
    stream: false,
    temperature: 0.0,
  },
...
export const completionTopK = createCompletionTest(
  'completion-top-k',
  {
    history: [{ role: 'user', content: 'What is 10 + 5? Answer with just the number.' }],
    stream: false,
    temperature: 0.5,
  },
  { validation: 'contains-all', contains: ['15'] },
...
export const completionNegativeTemperature = createCompletionTest(
  ...
  {
    history: [{ role: 'user', content: 'What is 1 + 1? Answer with just the number.' }],
    stream: false,
    temperature: -0.5,
  },
...
export const completionRepeatedTokens = createCompletionTest(
  ...
  { history: [{ role: 'user', content: 'Count from one to five using words.' }], stream: false },
...
export const completionWithWhitespace = createCompletionTest(
  ...
  { history: [{ role: 'user', content: '   What is 12 + 12?   Answer with just the number.   ' }], stream: false },
...
export const completionJsonFormat = createCompletionTest(
  ...
  {
    history: [{ role: 'user', content: 'Return this JSON: {"result": 25}. Just return the exact JSON.' }],
    stream: false,
  },
...
export const completionCodeGeneration = createCompletionTest(
  ...
  { history: [{ role: 'user', content: 'Write a hello world function in JavaScript.' }], stream: false },
...
export const completionQaFromContext = createCompletionTest(
  ...
  { history: [{ role: 'user', content: 'The sky is blue. What color is the sky?' }], stream: false },
  { validation: 'contains-all', contains: ['blue'] }
);

export const completionSimpleYesNo = createCompletionTest(
  'completion-simple-yes-no',
  { history: [{ role: 'user', content: 'Is 2+2=4? Answer yes or no.' }], stream: false },
...
export const completionSentenceCompletion = createCompletionTest(
  ...
  { history: [{ role: 'user', content: 'The quick brown fox' }], stream: false },
  { validation: 'type', expectedType: 'string' }
);
