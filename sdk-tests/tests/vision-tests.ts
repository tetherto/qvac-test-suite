...
const createVisionTest = (
  ...
  expectation,
  metadata: { category: 'vision', dependency: 'vision', estimatedDurationMs: 20000 },
  skip: visionSkipReason,
});

export const visionSimpleImage = createVisionTest('vision-simple-image', 'What do you see in this image?', 'cat.jpg', {
...
export const visionImageFormatPng = createVisionTest('vision-image-format-png', 'Describe this image.', 'logo.png', {
  validation: 'type',
  expectedType: 'string',
});
...
export const visionLargeImage = createVisionTest('vision-large-image', 'Describe this image.', 'large-4k.jpg', {
  validation: 'type',
  expectedType: 'string',
});
...
export const visionImageAndText = createVisionTest('vision-image-and-text', 'What do you see?', 'cat.jpg', {
  validation: 'type',
  expectedType: 'string',
});
...
const remainingVisionTests: TestDefinition[] = [
  ...
  testId,
  params: { history: [{ role: 'user', content: 'Test', attachments: [{ path: 'shared-test-data/images/cat.jpg' }] }] },
